...
#import "CETimeNumberView.h"
#import "CETimeDownConfig.h"

@interface CETimeDownView()

@property (nonatomic,strong) CETimeDownConfig *config;
...
@property (nonatomic,strong) CETimeNumberView *hourH;
@property (nonatomic,strong) CETimeNumberView *hourL;

@property (nonatomic,strong) CETimeNumberView *minuteH;
@property (nonatomic,strong) CETimeNumberView *minuteL;

@property (nonatomic,strong) CETimeNumberView *secondH;
@property (nonatomic,strong) CETimeNumberView *secondL;

@end

@implementation CETimeDownView
...
- (void)addTimeViews:(NSInteger)day {
    ...
    if (self.config.timeType == HSFTimeType_HOUR_MINUTE_SECOND) {
        ...
        px -= itemW;
        self.secondL = [[CETimeNumberView alloc] initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:9 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
        [self addSubview:self.secondL];
        
        px -= (itemW + space);
        self.secondH = [[CETimeNumberView alloc] initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:5 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
    ...
    px -= itemW;
    self.minuteL = [[CETimeNumberView alloc] initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:9 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
    [self addSubview:self.minuteL];
    
    px -= (itemW + space);
    self.minuteH = [[CETimeNumberView alloc] initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:5 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
    ...
    px -= itemW;
    self.hourL=[[CETimeNumberView alloc]initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:9 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
    [self addSubview:self.hourL];
    
    px -= (itemW + space);
    self.hourH = [[CETimeNumberView alloc]initWithFrame:CGRectMake(px, 0, itemW, height) maxNumber:5 fontSize:self.config.fontSize fontColor:self.config.fontColor bgColor:self.config.bgColor cornerRadius:self.config.cornerRadius];
